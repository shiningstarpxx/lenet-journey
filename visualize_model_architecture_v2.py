...
def visualize_conv1_architecture():
    ...
    # FC layers
    draw_layer_box(ax, 8.5, 6, 1.5, 0.8, 'FC1\n120', 'fc', '120 params')
    draw_layer_box(ax, 8.5, 4.8, 1.5, 0.8, 'FC2\n84', 'fc', '84 params')
    draw_layer_box(ax, 8.5, 3.6, 1.5, 0.8, 'FC3\n10', 'output', '10 params')
    
    # 箭头
    draw_arrow(ax, 2.5, 5.5, 3.5, 5.5)
    draw_arrow(ax, 5, 5.5, 6, 5.5)
    draw_arrow(ax, 7.5, 5.5, 8.5, 6.2)
    draw_arrow(ax, 7.5, 5.5, 8.5, 5.2)
    draw_arrow(ax, 7.5, 5.5, 8.5, 4)
...
def visualize_conv2_architecture():
    ...
    # FC layers
    draw_layer_box(ax, 8.5, 3, 1.5, 0.8, 'FC1\n120', 'fc', '48,120 params')
    draw_layer_box(ax, 8.5, 2, 1.5, 0.8, 'FC2\n84', 'fc', '10,164 params')
    draw_layer_box(ax, 8.5, 1, 1.5, 0.8, 'FC3\n10', 'output', '850 params')
    ...
    draw_arrow(ax, 12.5, 5.5, 8.5, 3.4)
    draw_arrow(ax, 12.5, 5.5, 8.5, 2.4)
    draw_arrow(ax, 12.5, 5.5, 8.5, 1.4)
...
def visualize_conv3_architecture():
    ...
    draw_arrow(ax, 15, 5.5, 11, 3.5)
    draw_arrow(ax, 12.5, 3.5, 8.5, 3.4)
    draw_arrow(ax, 12.5, 3.5, 8.5, 2.4)
    draw_arrow(ax, 12.5, 3.5, 8.5, 1.4)
...
def visualize_comparison():
    ...
    draw_layer_box(ax1, 8.5, 6, 1.5, 0.8, 'FC1\n120', 'fc')
    draw_layer_box(ax1, 8.5, 4.8, 1.5, 0.8, 'FC2\n84', 'fc')
    draw_layer_box(ax1, 8.5, 3.6, 1.5, 0.8, 'FC3\n10', 'output')
    
    draw_arrow(ax1, 2.5, 5.5, 3.5, 5.5)
    draw_arrow(ax1, 5, 5.5, 6, 5.5)
    draw_arrow(ax1, 7.5, 5.5, 8.5, 6.2)
    draw_arrow(ax1, 7.5, 5.5, 8.5, 5.2)
    draw_arrow(ax1, 7.5, 5.5, 8.5, 4)
    
    # 性能指标
    ax1.text(6, 2.5, '准确率: 98.38% | 参数: 152,410 | 效率: 0.65%', 
            ha='center', va='center', 
    ...
    draw_layer_box(ax2, 7, 3.5, 1.5, 0.8, 'FC1\n120', 'fc')
    draw_layer_box(ax2, 7, 2.5, 1.5, 0.8, 'FC2\n84', 'fc')
    draw_layer_box(ax2, 7, 1.5, 1.5, 0.8, 'FC3\n10', 'output')
    
    draw_arrow(ax2, 2.5, 5.5, 3, 5.5)
    draw_arrow(ax2, 4.5, 5.5, 5, 5.5)
    draw_arrow(ax2, 6.5, 5.5, 7, 5.5)
    draw_arrow(ax2, 8.5, 5.5, 9, 5.5)
    draw_arrow(ax2, 10.5, 5.5, 7, 3.9)
    draw_arrow(ax2, 10.5, 5.5, 7, 2.9)
    draw_arrow(ax2, 10.5, 5.5, 7, 1.9)
    ...
    draw_layer_box(ax3, 6.4, 3.5, 1.2, 0.8, 'FC1\n120', 'fc')
    draw_layer_box(ax3, 6.4, 2.5, 1.2, 0.8, 'FC2\n84', 'fc')
    draw_layer_box(ax3, 6.4, 1.5, 1.2, 0.8, 'FC3\n10', 'output')
    ...
    draw_arrow(ax3, 9.4, 4, 6.4, 3.9)
    draw_arrow(ax3, 9.4, 4, 6.4, 2.9)
    draw_arrow(ax3, 9.4, 4, 6.4, 1.9)
    ...
    plt.suptitle('不同层数卷积网络结构对比', fontsize=24, fontweight='bold', y=0.95)
    plt.tight_layout()
...
def main():
    ...
    try:
        ...
        fig1.savefig('./results/conv1_architecture_v2.png', dpi=300, bbox_inches='tight')
        print("✅ 1层卷积网络结构图已保存到: ./results/conv1_architecture_v2.png")
        
        # 2. 绘制2层卷积网络结构
        print("📊 绘制2层卷积网络结构...")
        fig2 = visualize_conv2_architecture()
        fig2.savefig('./results/conv2_architecture_v2.png', dpi=300, bbox_inches='tight')
        print("✅ 2层卷积网络结构图已保存到: ./results/conv2_architecture_v2.png")
        
        # 3. 绘制3层卷积网络结构
        print("📊 绘制3层卷积网络结构...")
        fig3 = visualize_conv3_architecture()
        fig3.savefig('./results/conv3_architecture_v2.png', dpi=300, bbox_inches='tight')
        print("✅ 3层卷积网络结构图已保存到: ./results/conv3_architecture_v2.png")
        
        # 4. 绘制对比图
        print("📊 绘制结构对比图...")
        fig4 = visualize_comparison()
        fig4.savefig('./results/conv_architectures_comparison_v2.png', dpi=300, bbox_inches='tight')
        print("✅ 结构对比图已保存到: ./results/conv_architectures_comparison_v2.png")
        ...
        print("\n🎉 所有美化结构图绘制完成!")
        print("\n📁 生成的文件:")
        print("- results/conv1_architecture_v2.png")
        print("- results/conv2_architecture_v2.png") 
        print("- results/conv3_architecture_v2.png")
        print("- results/conv_architectures_comparison_v2.png")
